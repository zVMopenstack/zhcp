...
#define PARSER_TABLE_NAME     Image_Console_Get_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageConsoleGetOutput

/**
 * Image_Console_Get SMAPI interface
 */
int smImage_Console_Get(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier,
        vmApiImageConsoleGetOutput ** outData) {
    const char * const functionName = "Image_Console_Get";
