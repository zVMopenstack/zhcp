...
int virtualChannelConnectionCreate(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Establishing a virtual network connection between %s and %s... ", image, coupledImage);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Channel_Connection_Create", rc, vmapiContextP);
    } else {
...
int virtualChannelConnectionCreateDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Adding a virtual network connection between %s's and %s's directory entries... ", image, coupledImage);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Channel_Connection_Create_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualChannelConnectionDelete(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Terminating virtual network connection for %s... ", image);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Channel_Connection_Delete", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualChannelConnectionDeleteDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Terminating virtual network connection from %s's directory entry... ", image);
    rc = smVirtual_Channel_Connection_Delete_DM(vmapiContextP, "", 0, "",  // Authorizing user, password length, password
            image, virtualAddress, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Channel_Connection_Delete_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterConnectLAN(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Connecting virtual network adapter at %s to %s... ", virtualAddress, lanName);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Connect_LAN", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterConnectLANDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Defining virtual network LAN connection in %s's directory entry... ", image);
    rc = smVirtual_Network_Adapter_Connect_LAN_DM(vmapiContextP, "", 0, "",
            image, deviceAddress, lanName, lanOwner, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Connect_LAN_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterConnectVswitch(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Connecting virtual network adapter at %s to %s... ", deviceAddress, vswitchName);
    rc = smVirtual_Network_Adapter_Connect_Vswitch(vmapiContextP, "", 0, "",
            image, deviceAddress, vswitchName, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Connect_Vswitch", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterConnectVswitchDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Defining virtual switch connection in %s's directory entry... ", image);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Connect_Vswitch_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterConnectVswitchExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Connecting virtual network adapter to an existing virtual switch... ");
    rc = smVirtual_Network_Adapter_Connect_Vswitch_Extended(vmapiContextP, "", 0, "", targetIdentifier, entryCount,
            entryArray, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Connect_Vswitch_Extended", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterCreate(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Adding virtual NIC to %s's active configuration... ", image);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Create", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterCreateDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Adding virtual NIC to %s's directory entry... ", image);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Create_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterCreateExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Adding virtual NIC to %s... ", targetIdentifier);
    rc = smVirtual_Network_Adapter_Create_Extended(vmapiContextP, "", 0, "", targetIdentifier, entryCount, entryArray, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Create_Extended", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterCreateExtendedDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Adding virtual NIC to %s's directory entry... ", targetIdentifier);
    rc = smVirtual_Network_Adapter_Create_Extended_DM(vmapiContextP, "", 0, "", targetIdentifier, entryCount, entryArray, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Create_Extended_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterDelete(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Removing virtual NIC from %s's active configuration... ", image);
    rc = smVirtual_Network_Adapter_Delete(vmapiContextP, "", 0, "",  // Authorizing user, password length, password
            image, virtualAddress, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Delete", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterDeleteDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Removing virtual NIC from %s's directory entry... ", image);
    rc = smVirtual_Network_Adapter_Delete_DM(vmapiContextP, "", 0, "",  // Authorizing user, password length, password.
            image, virtualAddress, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Delete_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterDisconnect(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Disconnecting virtual network adapter... ");
    rc = smVirtual_Network_Adapter_Disconnect(vmapiContextP, "", 0, "",  // Authorizing user, password length, password
            image, virtualAddress, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Disconnect", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterDisconnectDM(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Removing virtual network LAN or virtual switch connection from %s's directory entry... ", image);
    rc = smVirtual_Network_Adapter_Disconnect_DM(vmapiContextP, "", 0, "", image, virtualAddress, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Disconnect_DM", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkAdapterQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Adapter_Query", rc, vmapiContextP);
...
int virtualNetworkAdapterQueryExtended( int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP ) {
    ...
    if ( rc ) {
        printAndLogSmapiCallReturnCode( "Virtual_Network_Adapter_Query_Extended", rc, vmapiContextP );
    } else if ( output->common.returnCode || output->common.reasonCode ) {
        // Handle SMAPI return code and reason code
...
int virtualNetworkLANAccess(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Granting/revoking %s access to %s... ", accessGrantUser, lanName);
    rc = smVirtual_Network_LAN_Access(vmapiContextP, "", 0, "", image, lanName,
            lanOwner, accessOpt, accessGrantUser, promiscuity, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_LAN_Access", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkLANAccessQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_LAN_Access_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int virtualNetworkLANCreate(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Creating virtual network LAN %s... ", lanName);
    rc = smVirtual_Network_LAN_Create(vmapiContextP, "", 0, "", image, lanName, lanOwner, lanType, transportType, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_LAN_Create", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkLANDelete(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Deleting virtual network LAN %s... ", lanName);
    rc = smVirtual_Network_LAN_Delete(vmapiContextP, "", 0, "", image, lanName, lanOwner, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_LAN_Delete", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkLANQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_LAN_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int virtualNetworkOSAQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_OSA_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i =0; i < output->arrayCount; i ++) {
            ...
            if (token != NULL) {
                ...
                printf("Error osa_address is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error osa_status is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error chpid_address is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error agent_status is NULL!!\n");
                rc = 1;
                break;
            }
            printf("  OSA Address: %s \n"
                   "  OSA Status: %s\n"
                   "  OSA Type: %s\n"
                   "  CHPID Address: %s\n"
                   "  Agent Status: %s\n",
...
int virtualNetworkVLANQueryStats(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_VLAN_Query_Stats", rc, vmapiContextP);
    } else  if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i = 0; i < output->portNicArrayCount; i++) {
            ...
            if (strcmp(token,"PORT") == 0) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error nic_num is NULL!!\n");
                    rc = 1;
                    break;
                }
            } else {
                printf("Error invalid type received!!\n");
                rc = 1;
                break;
            }
            ...
            for (j = 0; j < output->portNicList[i].segmentCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error pseg_vlanid is NULL!!\n");
                    rc = 1;
                    break;
                }
                // Get pseg_rx
                ...
                if (token != NULL) {
                    ...
                    printf("Error pseg_rx_disc is NULL!!\n");
                    rc = 1;
                    break;
                }
                // Get pseg_tx
                ...
                if (token != NULL) {
                    ...
                    printf("Error pseg_tx_disc is NULL!!\n");
                    rc = 1;
                    break;
                }

                printf("pseg_vlanid = %s\n", pseg_vlanid);
                printf("pseg_rx = %s\n", pseg_rx);
                printf("pseg_rx_disc = %s\n", pseg_rx_disc);
                printf("pseg_tx = %s\n", pseg_tx);
                printf("pseg_tx_disc = %s\n", pseg_tx_disc);
                printf("\n");
            } //end of for j
        } //end of for i
...
int virtualNetworkVswitchCreate(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Creating virtual switch %s... ", switchName);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Create", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchCreateExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Create_Extended", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchDelete(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Deleting virtual switch %s... ", switchName);
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Delete", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchDeleteExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Deleting virtual switch... ");
    rc = smVirtual_Network_Vswitch_Delete_Extended(vmapiContextP, "", 0, "", targetIdentifier, entryCount, entryArray, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Delete_Extended", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchQueryExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Query_Extended", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i=0; i < output->vswitchArrayCountCalculated; i++ ) {
            ...
            if (token != NULL) {
                ...
                printf("Error switch_name is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error transport_type is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error port_type is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error queue_memory_limit is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error routing_value is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error vlan_awareness is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error native_vlan_id is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error mac_address is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error gvrp_request_attribute is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error gvrp_enabled_attribute is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error switch_status is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error lag_interval  is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error lag_group is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error IP_timeout is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error switch_type is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error isolation_status is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error MAC_protect is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("Error user_port_based is NULL!!\n");
                rc = 1;
                break;
            }
            ...
            for (j = 0; j < output->vswitchList[i].realDeviceCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error real_device_address is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error virtual_device_address is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error controller_name is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error device_status is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error device_error_status is NULL!!\n");
                    rc = 1;
                    break;
                }
                printf("real_device_address: %s\n"
            ...
            for (j = 0; j < output->vswitchList[i].authUserCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error grant_userid is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error promiscuous_mode is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error vlan_count is NULL!!\n");
                    rc = 1;
                    break;
                }
            ...
            for (j = 0; j < output->vswitchList[i].adapterCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error adapter_owner is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error adapter_vdev is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error adapter_macaddr is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error adapter_type is NULL!!\n");
                    rc = 1;
                    break;
                }
                printf("adapter_owner: %s\n"
                       "adapter_vdev: %s\n"
                       "adapter_macaddr: %s\n"
                       "adapter_type: %s\n",
            ...
            for (j = 0; j < output->vswitchList[i].uplinkNicCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error uplink_NIC_userid is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error uplink_NIC_vdev is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error uplink_NIC_error_status is NULL!!\n");
                    rc = 1;
                    break;
                }

                printf("uplink_NIC_userid: %s\n"
                       "uplink_NIC_vdev: %s\n"
            ...
            for (j = 0; j < output->vswitchList[i].globalMemberCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error global_member_name is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error global_member_state is NULL!!\n");
                    rc = 1;
                    break;
                }


                printf("global_member_name: %s\n"
...
int virtualNetworkVswitchQueryStats(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Query_Stats", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i = 0; i < output->vswitchArrayCount; i++) {
            ...
            for (j = 0; j < output->vswitchList[i].segmentCount; j++) {
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_rx_disc is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_tx_disc is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_activated_TOD is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf(" Error seg_config_update_TOD is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_vlan_interfaces is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                   ...
                   printf("Error seg_vlan_deletes is NULL!!\n");
                   rc = 1;
                   break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_device_type is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_device_addr is NULL!!\n");
                    rc = 1;
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("Error seg_device_status is NULL!!\n");
                    rc = 1;
                    break;
                }

                printf("segmentData number %d\n", j +1);
                printf("seg_vlanid            = %s\n", seg_vlanid);
                printf("seg_rx                = %s\n", seg_rx);
                printf("seg_rx_disc           = %s\n", seg_rx_disc);
                printf("seg_tx                = %s\n", seg_tx);
                printf("seg_tx_disc           = %s\n", seg_tx_disc);
                printf("seg_activated_TOD     = %s\n", seg_activated_TOD);
                printf("seg_config_update_TOD = %s\n", seg_config_update_TOD);
                printf("seg_vlan_interfaces   = %s\n", seg_vlan_interfaces);
                printf("seg_vlan_deletes      = %s\n", seg_vlan_deletes);
                printf("seg_device_type       = %s\n", seg_device_type);
                printf("seg_device_addr       = %s\n", seg_device_addr);
                printf("seg_device_status     = %s\n", seg_device_status);
                printf("\n");
            }
        }
    }
...
int virtualNetworkVswitchSet(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Set", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
...
int virtualNetworkVswitchSetExtended(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    printf("Changing virtual switch configuration ... ");
    rc = smVirtual_Network_Vswitch_Set_Extended(vmapiContextP, "", 0, "", targetIdentifier, entryCount, entryArray, &output);

    if (rc) {
        printAndLogSmapiCallReturnCode("Virtual_Network_Vswitch_Set_Extended", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code
