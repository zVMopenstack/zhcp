...
int systemDiskIOQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Disk_IO_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int systemEQIDQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_EQID_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i = 0; i < output->eqidArrayCount; i ++) {
        	if (eqidForIsEQID == 1) {
                ...
                if (token != NULL) {
                    ...
                    printf("ERROR: eqid_name is NULL\n");
                    break;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("ERROR: eqid_rdev is NULL\n");
                    break;
                }
        	} else {
                // Get eqid_rdev
...
int systemInformationQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Information_Query", rc, vmapiContextP);
...
int systemPageUtilizationQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    rc = smSystem_Page_Utilization_Query(vmapiContextP, "", 0, "", // Authorizing user, password length, password
            image, &output);
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Page_Utilization_Query", rc, vmapiContextP);
    } else if (rc || output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        if (token != NULL) {
            ...
            printf("ERROR: The total number of pages allocated for paging use on the system is NULL\n");
        }
        ...
        if (token != NULL) {
            ...
            printf("ERROR: The total number of pages in use for paging on the system is NULL\n");
        }
        ...
        if (token != NULL) {
            ...
            printf("ERROR: The percentage of the available paging space currently in use on the system is NULL\n");
        }
        ...
        while ( bytesleft > 0 ) {
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The volume ID of the paging volume is NULL\n");
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The RDEV of the paging volume is NULL\n");
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The total number of pages on the volume available for paging use is NULL\n");
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The total number pages in use on the volume for paging files is NULL\n");
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The percentage of the available paging space on the volume in use is NULL\n");
                break;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The drained information of the paging space on the volume is NULL\n");
                break;
            }
...
int systemPerformanceInformationQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Performance_Information_Query", rc, vmapiContextP);
    } else if (output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int systemServiceQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Service_Query", rc, vmapiContextP);
    } else if (rc || output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
...
int systemShutdown(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Shutdown", rc, vmapiContextP);
    } else {
        // Handle SMAPI return code and reason code and Error Buffer if it was sent
...
int systemSpoolUtilizationQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    rc = smSystem_Spool_Utilization_Query(vmapiContextP, "", 0, "", // Authorizing user, password length, password
            image, &output);
    if (rc) {
        printAndLogSmapiCallReturnCode("System_Spool_Utilization_Query", rc, vmapiContextP);
    } else if (rc || output->common.returnCode || output->common.reasonCode) {
        // Handle SMAPI return code and reason code
        ...
        for (i = 0; i < output->systemSpoolInformationCount; i++) {
            ...
            token = strtok_r(tempBuff, blank, &buffer);
     	    ...
     	    if (i == 0) {
                ...
                if (token != NULL) {
                    ...
                    printf("ERROR: The total number of pages allocated for spool use on the system is NULL\n");
                    return 1;
                }
                ...
                if (token != NULL) {
                    ...
                    printf("ERROR: The total number of pages in use for spool on the system is NULL\n");
                ...
                if (token != NULL) {
                    ...
                    printf("ERROR: The percentage of the available spool space currently in use on the system is NULL\n");
                    return 1;
                }
                printf("\n");
                printf("Total allocated: %s\n"
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The volume ID of the spool volume is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The RDEV of the spool volume is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The total number of pages on the volume available for spool use is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The total number pages in use on the volume for spool files is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The percentage of the available spool space on the volume in use is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The DUMP space information of the spool space on the volume is NULL\n");
                return 1;
            }
            ...
            if (token != NULL) {
                ...
                printf("ERROR: The drained information of the spool space on the volume is NULL\n");
                return 1;
            }
...
int systemWWPNQuery(int argC, char* argV[], struct _vmApiInternalContext* vmapiContextP) {
    ...
    while ((option = getopt(argC, argV, optString)) != -1)
        switch (option) {
            ...
            case '?':  // Missing option data or invalid option
                printf("\nERROR: Missing option data or invalid option\n");
                FREE_MEMORY_CLEAR_POINTER(entryArray);
                return 1;
                break;
